...
var structIns = [ins(
    ...
    artists:[
        ...
        Cont(image: "InsightI13", title:"\nChiara De Marchi", descr: "Samanta has dedicated her life to improving the visibility of disabled people in the fashion industry and enhancing the clothing that is available. She has been a wheelchair user model from an early age and works as an advocate for inclusion within the fashion industry. She is also a ParaPan Am Doubles Silver medalist in wheelchair tennis.", fonte:"Photographer", link: "https://www.instagram.com/invisiblebodydisabilities/"),
