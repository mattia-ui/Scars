...
var structIns = [ins(
    ...
    mov:[
        Cont(image: "InsightA1", title:"My scars: journey to body acceptance", descr: "'My accidental fall into boiling water happened at home, when I was three. I ended up in hospital on life support. Many operations followed….'", fonte:"From Sylvia Mac on mentalhealth.org", link: "https://www.mentalhealth.org.uk/stories/my-scars-journey-body-acceptance"),
        Cont(image: "InsightA2", title:"Beyond Skin Deep: How Scars Affect Psychosocial Well-Being", descr: "'…the psychosocial impact of scarring from the treatment of facial skin cancers has been shown to affect the young, old, male and female alike.'", fonte:"From Katie Delach on pennmedicine.org", link: "https://www.pennmedicine.org/news/news-blog/2015/may/beyond-skin-deep-how-scars-aff"), Cont(image: "InsightA3", title:"The effects of scars on mind", descr: "'The research suggests a healthy body image and high self-esteem can lead to you feeling good about yourself.'", fonte:"On nourisilmd.co.uk", link: "https://www.nourisilmd.co.uk/effects-of-scars-on-the-mind/"),
        Cont(image: "InsightA4", title:"Kintsugi: the art of precious scars", descr: "'By repairing broken ceramics it’s possible to give a new lease of life to pottery that becomes even more refined thanks to its scars.'", fonte:"Stefano Carnazzi on lifegate.com", link: "https://www.lifegate.com/people/lifestyle/kintsugi"), Cont(image: "InsightA5", title:"5 ways to build lasting self-esteem", descr: "When our self-esteem is higher, we are also less vulnerable to anxiety; we release less cortisol into our bloodstream when under stress, and it is less likely to linger in our system.", fonte:"Guy Winch on ideas.ted.com", link: "https://ideas.ted.com/5-ways-to-build-lasting-self-esteem/"),
        Cont(image: "InsightA6", title:"Learning to Accept (if Not Love) My Scar", descr: "Although “my scar” — and I do feel proprietary about it — has been a part of me for more than three decades, an answer still doesn’t come easily. My first inclination was to pretend I hadn’t heard the question.", fonte:"Steven Petrow on nytimes.com", link: "https://www.nytimes.com/2017/12/15/well/live/scar-surgery-cancer-shame-self.html"), Cont(image: "InsightA7", title:"Loving your body, scars and all", descr: "'It is genuinely hard to cope with some scars, but try and remember that the important thing about you is the person you are inside and that you love yourself, scars and all.'", fonte:"Fascia on bodyinharmony.org", link: "https://www.bodyinharmony.org.uk/blog/loving-your-body-scars-and-all")],
    art:[
