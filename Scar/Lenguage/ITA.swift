    ...
    static var lingua = ["English","Italian"]
        ...
        static var textOnSettings = ["Language","About us"]
         ...
         static var goToLink: [String] = ["SeeMoreIta","SeeMoreMoviesIta","SeeMoreArticleIta","SeeMoreBooksIta","SeeMoreInspiringPeopleIta","SeeMorePodcastIta"]
                ...
                static var sfondiNav: [String] = ["MirrorWorkIta","BeInspiredIta","TheJournalIta","TakeAWalkIta","MeditateIta","DoExerciseIta","ASmileIta","DailyGoalsIta","EnjoySunlightIta"]
            
                static var allCardsImages: [String] = ["Card1pIta","Card2pIta","Card3pIta","Card4pIta","Card5pv","Card6pIta","Card7pIta","Card8pIta","Card9pIta"]
               ...
               static var textOnCollage = [
                    ...
                    pod:[
                        ...
                        artists:[
                            ...
                            Cont(image: "Erin_Stewart", title:"\nErin Stewart", descr: "Erin è cresciuta nei boschi della Virginia catturando lucciole. Ama usare il suo background nel giornalismo per ricercare e scrivere romanzi basati sulla vita reale. Sopravvissuta allo scompenso cardiaco e madre adottiva, crede che la vita getti colpi di scena e persone nella nostra strada per una ragione, sempre. Scars Like Wings è il suo romanzo d'esordio.", fonte:"Autrice", link: "https://www.instagram.com/erin_n_stewart/"),
                    ...
                    static var textOnViewController = ["Traccia e"," riempi la forma"," del tuo segno."]
                     ...
                     static var textOnPrimaTutorial = ["Hi,","This is Skinsugi!","We are glad that you came to us.","What's your name?","My name is..","Reflect, we don’t need your answer.","Last step","How do you feel about your sign? How do you think others see it?",]
