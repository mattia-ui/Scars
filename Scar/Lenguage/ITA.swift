...
class ITA: UIViewController{
    ...
    static var Schemata1Text = ["Pronto per una dose di autostima?","Giornaliere","Settimanale"]
                    ...
                    static var textOnAddInsights = ["I tuoi interessi","Personalizza i tuoi Insights"]
                    ...
                    static var textOnSharePage = ["Condividere le tue emozioni con gli altri è fondamentale per la tua ","emotività ","e ","rafforza l autostima",",allontana le insicurezze, e ti insegna che ","non sei solo",", mai.\n","Cosa stai aspettando?\nRacconta la tua storia e condividila su ","Instagram ","con l'hashtag ","o invialo a noi in forma anonima puoi essere d'ispirazione anche senza mostrare il tuo nome!\n ","Scrivi la storia che si cela dietro il tuo segno indelebile…  - ","(max 1100 caratteri)","La tua storia è stata copiata correttamente","Ispira gli altri","Non ora","Copia","(Lo pubblicheremo sul nostro profilo)"]
                    
                    static var textOnGenerateAgain = ["Il pattern nel cerchio più grande descrive ","la tua personalità ","e il colore al suo interno rappresenta ","il modo in cui vuoi apparire"," dall’esterno.\nLe due forme geometriche all’esterno raccontano"," il modo in cui vorresti essere "," e la texture al loro interno rappresenta ","la percezione che hai del tuo segno indelebile",", che è in oro ed occupa il centro dell’immagine, come ","l’arte del Kintsugi ","insegna!","Cerchio",": empatia - socialità","Zig Zag",": estro - ambizione","Triangolo",": leadership - tenacia","Rettangolo",": curiosità - caos","Quadrato", ": cautela - precisione","Il tuo Skinsugi Masterpiece è stato copiato correttamente","yourmasterpiece-1Ita"]
     static var textPostCollage = ["Crea il tuo Masterpiece!","navInsta8Ita","navinstaIta","Inviato","Grazie per aver condiviso il tuo capolavoro con noi"]
