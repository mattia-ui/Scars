...
var weeklyInfo: [WeeklyStruct] = [
    ...
    WeeklyStruct(title:"Follow a passion, dedicate yourself to a hobby",descr: "If you love something, why not do it? There is no room for criticism here, there is only you and your passions. Be positive, be creative and enjoy it.", image:"Weekly1.png"),
    WeeklyStruct(title:"Try new things, get out of your comfort zone",descr: "Did you know that a comfort zone is a self-imposed boundary that a person refuses to cross? What are you waiting for? Try new flavors, wear new colors and do something you've never done before!", image:"2-.png"),
    WeeklyStruct(title:"Become aware of your difficulties",descr: "A. Einstein said: ‘If you judge a fish by its ability to climb a tree, it will live its whole life believing that it is stupid.’ Accept your limits but after a failure always be ready to rediscover yourself again.", image:"2-.png"),  WeeklyStruct(title:"List the things you like about your body",descr: "Today remember that there is no one else in the world who is just like you. The things that make you unique are what make you special. Think about what you love most about yourself and be proud of it!", image:"2-.png"),
    WeeklyStruct(title:"Stay in contact with nature",descr: "Did you know that contact with nature affects our relationship with other people and makes us less irritable? So today turn off your phone for a while and get outside. ", image:"2-.png"),
    WeeklyStruct(title:"Surround yourself with positive people and talk with them",descr: "Today try to avoid critical and negative people who have a problem for each solution. Let go of negativity, surround yourself by positive people, make pancakes and enjoy!", image:"2-.png"),
    WeeklyStruct(title:"Make a list or rethink your achievements",descr: "When you set yourself a goal to reach, it seems unreachable. Today make a list of all the obstacles you have overcome, you will discover that they do not even have half the strength you have!", image:"2-.png")
]
