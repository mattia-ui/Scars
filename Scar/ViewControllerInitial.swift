...
var dati = [ActivityStruct(
    ...
    attivita5:
        [ContenutoStruct(contenuto:"Meditation is a method of knowing yourself deeply, it can be used as a simple technique of relax or as a tool for the growth of awareness, spirituality or generally as a form of self-care.\n\nYou will find below some small tips that will help you along the way: ready to get started?", titolo: "Look for your mantra", righe: 15),
        ContenutoStruct(contenuto: "Concentrate on breathing and free your mind of unnecessary thoughts.", titolo: "1. Learn to meditate on your breathing", righe: 20),
        ContenutoStruct(contenuto: "Try to be aware of the posture you adopt, focus all your attention on your body.", titolo: "2. Check your posture", righe: 25),
        ContenutoStruct(contenuto: "The eyes must not be open, to avoid distractions, but not closed either, to avoid falling asleep.", titolo: " 3. Squint your eyes", righe: 31),
        ContenutoStruct(contenuto: "To increase your concentration on the breath you can use a mantra, it is a short sentence, which you can repeat over and over again.", titolo: " 4. Use a mantra", righe: 37),
        ContenutoStruct(contenuto: "It is important to dedicate enough time to this practice. The ideal would be two meditation sessions, the first in the morning and the second in the evening. Meditation is not an occasional practice, it is very important to meditate every day, even for just a few minutes.", titolo: "5. Find your ideal time", righe: 46)],
    attivita6:
