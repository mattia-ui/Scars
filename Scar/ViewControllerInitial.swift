...
var dati = [ActivityStruct(
    ...
    attivita2:
        ...
        ContenutoStruct(contenuto: "Remember that you can change yourself but not others! Don’t think about what other people might say or think. They don’t matter at all. just think about what YOU feel.", titolo: "2. Stop listening to negativity", righe: 11),
        ContenutoStruct(contenuto: "Your body deserves respect, attention and love. Look yourself in the mirror, appreciate all the perfect things about you and write them in your diary.", titolo: "3. Write in a positive way about your body", righe: 11),
        ContenutoStruct(contenuto: "To understand yourself better you are going to keep track of your overall progress. A reliable way in which you can do this is by rating how you feel EACH day.", titolo: "4. Rate how you feel each day", righe: 11),
        ContenutoStruct(contenuto: "Probably after some time your passion for writing may wane, but don't worry. Remember that: consistency is the key. A useful way to not give up is to reward yourself for each writing session you end.", titolo: "5. Never give up!", righe: 11)],
    attivita3:
        [ContenutoStruct(contenuto: "If you are struggling with your body image issues or you are trying to increase your self-esteem, being inspired by someone who has had an experience similar to yours can be just the kick start you need to feel better about yourself.\n\nAn easy and fun way to be inspired by others is to collect quotes or story from your favorite celebrity or Instagram influencer, but also from authors and regular people.", titolo: "Inspiration matters", righe: 11),
        ContenutoStruct(contenuto: "• Save your favorite quotes or stories for your next low self-esteem day \n• Write them on colored sticky notes\n• Share them with your friends\n• Read them out loud when you look in the mirror\n• Put them into practice.", titolo: "Let's see together how to get inspired", righe: 11)],
    attivita4:
        [ContenutoStruct(contenuto: "Try to walk for at least 30 minutes. If it's too difficult for you, don't worry. Take small regular 10-minute walks three times a day and then gradually switch to longer sessions.\n\nPeople who exercise regularly tend to do so because it gives them a great sense of well-being, they feel more relaxed and positive about themselves and their lives.\n\nWalking requires minimal equipment, can be done at any time of day and can be performed at your own pace.. so no excuses!", titolo: "Walking is important", righe: 11)],
    attivita5:
        ...
        ContenutoStruct(contenuto: "Concentrate on breathing and free your mind of unnecessary thoughts.", titolo: "1. Learn to meditate on your breathing", righe: 11),
        ContenutoStruct(contenuto: "Try to be aware of the posture you adopt, focus all your attention on your body.", titolo: "2. Check your posture", righe: 11),
        ContenutoStruct(contenuto: "The eyes must not be open, to avoid distractions, but not closed either, to avoid falling asleep.", titolo: " 3. Squint your eyes", righe: 11),
        ContenutoStruct(contenuto: "To increase your concentration on the breath you can use a mantra, it is a short sentence, which you can repeat over and over again.", titolo: " 4. Use a mantra", righe: 11),
        ContenutoStruct(contenuto: "It is important to dedicate enough time to this practice. The ideal would be two meditation sessions, the first in the morning and the second in the evening. Meditation is not an occasional practice, it is very important to meditate every day, even for just a few minutes.", titolo: "5. Find your ideal time.", righe: 11)],
    attivita6:
    ...
    attivita9:
        [ContenutoStruct(contenuto: "Your mind is the only useful and essential tool you have to manage and plan your thoughts, aspirations and goals. If you plan your goals it will be much easier to shape the life you want and get the results you want to achieve.\n\nLet's see together how to manage the difficulties and reach the goal:", titolo: "Plan, manage and reach", righe: 11),
         ContenutoStruct(contenuto: "Classify them according to the importance they have for you and understand the steps you need to take in order to achieve them.", titolo: "1. Make a list of all the goals you want to achieve", righe: 11),
...
class ViewControllerInitial: UIViewController, UIScrollViewDelegate {
    ...
    func setupSlideScrollView(slides : [Slide]) {
        ...
        scrollView.contentSize = CGSize(width: view.frame.width , height: 30 * CGFloat(numberL) + 100)
    }
}
