...
var dati = [ActivityStruct(
    attivita1:[
        ContenutoStruct(contenuto: "Doing mirror work is one of the most loving gifts you can give yourself. Remember that the more you use your mirror for complimenting and supporting yourself, the deeper and more pleasant your relationship with yourself will become.\nHere are three simple steps for mastering your mirror work in practice!\n" , titolo: "Your mirror is your friend", righe: 15), ContenutoStruct(contenuto:"Using a handheld mirror allows you to get closer to the most intimate part of yourself. Just make sure you're in a place where nobody can bother you!" , titolo: "1. Get a handheld mirror", righe: 22), ContenutoStruct(contenuto: "Start by making eye contact with yourself in the mirror and don't worry if at first this may seem a little uncomfortable.", titolo: "2. Make eye contact", righe: 28), ContenutoStruct(contenuto: "Now begin to say some of your favorite affirmations out loud or just start a conversation with yourself. It’s so important to give yourself little positive messages, say anything that makes you feel really good!\n \n", titolo: "3. Give yourself positive messages out loud",righe: 35)],
    attivita2:
        [ContenutoStruct(contenuto: "Taking some time and writing a journal could help you improve your body image. Writing activities could be used as a form of therapy for people who have self-esteem and body issues.\nReady to get started? Here are some small tips that will help you along the way:\n", titolo: "The importance of writing", righe: 14),
        ContenutoStruct(contenuto: "Everyone has his own times: if you are an early riser, you can update your journal in the morning but if you are a night owl, choose to update it in the evening.", titolo: "1. Choose a suitable time for you", righe: 21),
        ContenutoStruct(contenuto: "Remember that you can change yourself but not others! Don’t think about what other people might say or think. They don’t matter at all. Just think about what you feel.", titolo: "2. Stop listening to negativity", righe: 28),
        ContenutoStruct(contenuto: "Your body deserves respect, attention and love. Look yourself in the mirror, appreciate all the perfect things about you and write them in your diary.", titolo: "3. Write in a positive way about your body", righe: 35),
        ContenutoStruct(contenuto: "To understand yourself better you are going to keep track of your overall progress. A reliable way in which you can do this is by rating how you feel each day.", titolo: "4. Rate how you feel each day", righe: 42),
        ContenutoStruct(contenuto: "Probably after some time your passion for writing may wane, but don't worry. Remember that: consistency is the key. A useful way to not give up is to reward yourself for each writing session you end.", titolo: "5. Never give up!", righe: 49)],
    attivita3:
        [ContenutoStruct(contenuto: "If you are struggling with your body image issues or you are trying to increase your self-esteem, being inspired by someone who has had an experience similar to yours can be just the kick start you need to feel better about yourself.\nAn easy and fun way to be inspired by others is to collect quotes or story from your favorite celebrity or Instagram influencer, but also from authors and regular people.\n", titolo: "Inspiration matters", righe: 17),
        ContenutoStruct(contenuto: "• Save your favorite quotes or stories for your next low self-esteem day \n• Write them on colored sticky notes\n• Share them with your friends\n• Read them out loud when you look in the mirror\n• Put them into practice", titolo: "Let's see together how to get inspired", righe: 26)],
    attivita4:
        [ContenutoStruct(contenuto: "Try to walk for at least 30 minutes. If it's too difficult for you, don't worry. Take small regular 10-minute walks three times a day and then gradually switch to longer sessions.\n\nPeople who exercise regularly tend to do so because it gives them a great sense of well-being, they feel more relaxed and positive about themselves and their lives.\n\nWalking requires minimal equipment, can be done at any time of day and can be performed at your own pace.. so no excuses!\n", titolo: "Walking is important", righe: 20)],
    attivita5:
        [ContenutoStruct(contenuto:"Meditation is a method of knowing yourself deeply, it can be used as a simple technique of relax or as a tool for the growth of awareness, spirituality or generally as a form of self-care.\nHere you have some small tips that will help you along the way: ready to get started?", titolo: "Look for your mantra", righe: 14),
        ContenutoStruct(contenuto: "Concentrate on breathing and free your mind of unnecessary thoughts.", titolo: "1. Learn to meditate on your breathing", righe: 19),
        ContenutoStruct(contenuto: "Try to be aware of the posture you adopt, focus all your attention on your body.", titolo: "2. Check your posture", righe: 24),
        ContenutoStruct(contenuto: "The eyes must not be open, to avoid distractions, but not closed either, to avoid falling asleep.", titolo: " 3. Squint your eyes", righe: 30),
        ContenutoStruct(contenuto: "To increase your concentration on the breath you can use a mantra, it is a short sentence, which you can repeat over and over again.", titolo: " 4. Use a mantra", righe: 36),
        ContenutoStruct(contenuto: "It is important to dedicate enough time to this practice. The ideal would be two meditation sessions, the first in the morning and the second in the evening. Meditation is not an occasional practice, it is very important to meditate every day, even for just a few minutes.", titolo: "5. Find your ideal time", righe: 45)],
    attivita6:
        [ContenutoStruct(contenuto: "\nRegular exercises can have a deeply positive impact on your daily life. But don’t worry, you don’t have to torture yourself with difficult exercises to get what you want. You can build confidence and do your exercises on your own terms and on your own times.\nLet's see together some exercises you can do:", titolo: "What are the exercises that affect your \nmood in a positive way?", righe: 16),
        ContenutoStruct(contenuto: "Yoga develops inner awareness by focusing your attention on what you are experiencing in the present moment without judging yourself.", titolo: "1. Yoga", righe: 23),
        ContenutoStruct(contenuto: "Pilates is a training method that teaches you to become aware of your body, correct your posture and improve the precision of your movements.", titolo: "2. Pilates", righe: 30),
        ContenutoStruct(contenuto: "Tai Chi is a discipline of ancient origins, close to the world of martial arts, useful for strengthening the character, the elasticity of the muscles and the improvement of posture.", titolo: "3. Tai Chi", righe: 36)],
    attivita7:
        [ContenutoStruct(contenuto: "Do you remember when was the last time you smiled? Smiling is good for health and generates positive reactions for your body.\n\nAnd if you think you have no reason to laugh, invent it, look around for something funny like a good comedy or a joke! Your whole body will thank you!\n\nYou will find below 3 reasons why smiling is good for your health!\n\n- Smiling improves productivity at work, a smile can create bonds in the team, reduce the level of stress and help you solve problems with more lucidity.\n\n- Smiling makes you creative, the more relaxed you are, the more inclined your mind is to create.\n\n- Smiling makes you sleep better, smiling in the evening increases the production of melatonin which helps you sleep.\n\n...so smile without moderation!", titolo: "There is always a reason to smile", righe: 33)],
    attivita8:
        [ContenutoStruct(contenuto: "Sunlight brings mental well-being, improves mood and removes stress.\n\nThe benefits are many but .. How to expose yourself to sunlight while staying at home?\n\nIf you have a balcony organize yourself with a comfortable chair and try to spend time outdoors every day.\n\nAnd what if you don't have a balcony? Try to identify the times of day when the light enters directly from your windows. Open it and sit in favor of the sunlight.\nUse every moment of pause you have and expose yourself to sunlight every day.", titolo: "What does sunlight do to your body?", righe: 23)],
    attivita9:
        [ContenutoStruct(contenuto: "Your mind is the only useful and essential tool you have to manage and plan your thoughts, aspirations and goals. If you plan your goals it will be much easier to shape the life you want and get the results you want to achieve.\nLet's see together how to manage the difficulties and reach the goal:", titolo: "Plan, manage and reach", righe: 16),
         ContenutoStruct(contenuto: "\nClassify them according to the importance they have for you and understand the steps you need to take in order to achieve them.", titolo: "1. Make a list of all the goals you want to achieve", righe: 23),
         ContenutoStruct(contenuto: "\nDoing this can reduce stress and make you happier and more pleased.\nSet deadlines, setting deadlines will increase your motivation and give you feedback on what works and what doesn’t. Give yourself a reward, when you reach a goal don't forget to reward yourself, this will make you happier and more motivated to take the next step.", titolo: "\n2. Divide your biggest goals into daily steps", righe: 36)]
)]
...
class ViewControllerInitial: UIViewController, UIScrollViewDelegate {
    ...
    var sfondiNav: [String] = ["MirrorWork1","TheJournal1","TakeAWalk","BeInspired","EnjoySunlight","DoExercise","ASmile","DailyGoals","Meditate"]
    ...
    func setupSlideScrollView(slides : [Slide]) {
        ...
        for i in 0 ..< slides.count {
            ...
            if(i != 0){
                slides[i].labelTitle.font = UIFont(name: "Nexa Bold", size: 17.0)
                slides[i].labelDesc.font = UIFont(name: "NexaTextDemo-Light", size: 17.0)
            } else {
                slides[i].labelTitle.font = UIFont(name: "Nexa Bold", size: 17.0)
                slides[i].labelDesc.font = UIFont(name: "NexaTextDemo-Light", size: 17.0)
            }
