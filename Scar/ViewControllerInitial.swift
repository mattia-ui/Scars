...
var dati = [ActivityStruct(
    attivita1:[
        ContenutoStruct(contenuto: "Doing mirror work is one of the most loving gifts you can give yourself. Remember that the more you use your mirror for complimenting and supporting yourself, the deeper and more pleasant your relationship with yourself will become.\n \nHere are three simple steps for mastering your mirror work in practice!" , titolo: "Your mirror is your friend", righe: 12), ContenutoStruct(contenuto:"Using a handheld mirror allows you to get closer to the most intimate part of yourself. Just make sure you're in a place where nobody can bother you!" , titolo: "1. Get a handheld mirror", righe: 19), ContenutoStruct(contenuto: "Start by making eye contact with yourself in the mirror and don't worry if at first this may seem a little uncomfortable.", titolo: "2. Make eye contact", righe: 25), ContenutoStruct(contenuto: "Now begin to say some of your favorite affirmations out loud or just start a conversation with yourself. It’s so important to give yourself little positive messages, say anything that makes you feel really good!", titolo: "3. Give yourself positive messages out loud",righe: 32)],
    attivita2:
    ...
    attivita5:
        ...
        ContenutoStruct(contenuto: "Concentrate on breathing and free your mind of unnecessary thoughts.", titolo: "1. Learn to meditate on your breathing", righe: 16),
        ContenutoStruct(contenuto: "Try to be aware of the posture you adopt, focus all your attention on your body.", titolo: "2. Check your posture", righe: 21),
        ContenutoStruct(contenuto: "The eyes must not be open, to avoid distractions, but not closed either, to avoid falling asleep.", titolo: " 3. Squint your eyes", righe: 27),
        ContenutoStruct(contenuto: "To increase your concentration on the breath you can use a mantra, it is a short sentence, which you can repeat over and over again.", titolo: " 4. Use a mantra", righe: 33),
    ...
    attivita9:
        [ContenutoStruct(contenuto: "Your mind is the only useful and essential tool you have to manage and plan your thoughts, aspirations and goals. If you plan your goals it will be much easier to shape the life you want and get the results you want to achieve.\n\nLet's see together how to manage the difficulties and reach the goal:", titolo: "Plan, manage and reach", righe: 11),
         ContenutoStruct(contenuto: "\nClassify them according to the importance they have for you and understand the steps you need to take in order to achieve them.", titolo: "1. Make a list of all the goals you want to achieve", righe: 18),
