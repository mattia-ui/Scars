...
var dati = [ActivityStruct(
    attivita1:[
        ContenutoStruct(contenuto: "Doing mirror work is one of the most loving gifts you can give yourself. Remember that the more you use your mirror for complimenting and supporting yourself, the deeper and more pleasant your relationship with yourself will become.\n \nHere are three simple steps for mastering your mirror work in practice!" , titolo: "Your mirror is your friend", righe: 14), ContenutoStruct(contenuto:"Using a handheld mirror allows you to get closer to the most intimate part of yourself. Just make sure you're in a place where nobody can bother you!" , titolo: "1. Get a handheld mirror", righe: 21), ContenutoStruct(contenuto: "Start by making eye contact with yourself in the mirror and don't worry if at first this may seem a little uncomfortable.", titolo: "2. Make eye contact", righe: 27), ContenutoStruct(contenuto: "Now begin to say some of your favorite affirmations out loud or just start a conversation with yourself. It’s so important to give yourself little positive messages, say anything that makes you feel really good!", titolo: "3. Give yourself positive messages out loud",righe: 34)],
    attivita2:
        [ContenutoStruct(contenuto: "Taking some time and writing a diary could help you improve your body image. Writing activities could be used as a form of therapy for people who have self-esteem and body issues.\nReady to get started? Here are some small tips that will help you along the way:", titolo: "The importance of writing", righe: 12),
        ContenutoStruct(contenuto: "Everyone has his own times: If you are an early riser, you can update your diary in the morning but If you are a night owl, choose to update it in the evening. ", titolo: "1. Choose a suitable time for you. ", righe: 19),
        ...
        ContenutoStruct(contenuto: "Your body deserves respect, attention and love. Look yourself in the mirror, appreciate all the perfect things about you and write them in your diary.", titolo: "3. Write in a positive way about your body", righe: 33),
    ...
    attivita4:
        [ContenutoStruct(contenuto: "Try to walk for at least 30 minutes. If it's too difficult for you, don't worry. Take small regular 10-minute walks three times a day and then gradually switch to longer sessions.\n\nPeople who exercise regularly tend to do so because it gives them a great sense of well-being, they feel more relaxed and positive about themselves and their lives.\n\nWalking requires minimal equipment, can be done at any time of day and can be performed at your own pace.. so no excuses!", titolo: "Walking is important", righe: 18)],
    attivita5:
        [ContenutoStruct(contenuto:"Meditation is a method of knowing yourself deeply, it can be used as a simple technique of relax or as a tool for the growth of awareness, spirituality, or generally as s form of self-care.\n\nYou will find below some small tips that will help you along the way: Ready to get started?", titolo: "Look for your mantra", righe: 13),
        ContenutoStruct(contenuto: "Concentrate on breathing and free your mind of unnecessary thoughts.", titolo: "1. Learn to meditate on your breathing", righe: 18),
        ContenutoStruct(contenuto: "Try to be aware of the posture you adopt, focus all your attention on your body.", titolo: "2. Check your posture", righe: 23),
        ContenutoStruct(contenuto: "The eyes must not be open, to avoid distractions, but not closed either, to avoid falling asleep.", titolo: " 3. Squint your eyes", righe: 29),
        ContenutoStruct(contenuto: "To increase your concentration on the breath you can use a mantra, it is a short sentence, which you can repeat over and over again.", titolo: " 4. Use a mantra", righe: 35),
        ContenutoStruct(contenuto: "It is important to dedicate enough time to this practice. The ideal would be two meditation sessions, the first in the morning and the second in the evening. Meditation is not an occasional practice, it is very important to meditate every day, even for just a few minutes.", titolo: "5. Find your ideal time.", righe: 44)],
    attivita6:
        [ContenutoStruct(contenuto: "\nRegular exercise can have a deeply positive impact on your daily life. But don’t worry, you don’t have to torture yourself with difficult exercises to get what you want. You can build confidence and do your exercises on your own terms and on your own times.\nLet's see together some exercises you can do:", titolo: "What are the exercises that affect your mood in a positive way?", righe: 14),
        ContenutoStruct(contenuto: "Yoga develops inner awareness by focusing your attention on what you are experiencing in the present moment without judging yourself.", titolo: "1. Yoga", righe: 21),
        ContenutoStruct(contenuto: "Pilates is a training method that teaches you to become aware of your body, correct your posture and improve the precision of your movements", titolo: "2. Pilates", righe: 28),
        ContenutoStruct(contenuto: "Tai Chi is a discipline of ancient origins, close to the world of martial arts, useful for strengthening the character, the elasticity of the muscles and the improvement of posture.", titolo: "3. Tai Chi", righe: 34)],
    attivita7:
...
class ViewControllerInitial: UIViewController, UIScrollViewDelegate {
    ...
    var slides:[Slide] = []
    var sfondi: [String] = ["background","background2","background3","background4","background5","BackDo","background7","background8","background9"]
    ...
    func setupSlideScrollView(slides : [Slide]) {
        ...
        for i in 0 ..< slides.count {
            ...
            if(i != 0){
                slides[i].labelTitle.font = UIFont(name: "CeraPro-MediumItalic", size: 17.0)
                slides[i].labelDesc.font = UIFont(name: "CeraPro-Light", size: 17.0)
            } else {
                slides[i].labelTitle.font = UIFont(name: "CeraPro-Medium", size: 17.0)
                slides[i].labelDesc.font = UIFont(name: "CeraPro-Light", size: 17.0)
            }
